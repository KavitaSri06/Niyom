    ...
    <div className="min-h-screen bg-white">
      <nav className={`bg-black text-white shadow-lg sticky top-0 z-50 ${isLoaded ? 'animate-fadeIn' : 'opacity-0'}`}>
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-between items-center px-6 py-5">
            ...
            <div className="hidden md:flex items-center gap-3">
              <div className="relative">
                ...
                {isEmployeeDropdownOpen && (
                  <div
                    onMouseEnter={() => setIsEmployeeDropdownOpen(true)}
                    onMouseLeave={() => setIsEmployeeDropdownOpen(false)}
                    className="absolute top-full right-0 mt-0 bg-black border border-[#c9b896]/20 rounded-md shadow-lg min-w-[160px] z-50"
                  >
                    <button
              ...
              <button
                ...
                className={`bg-[#c9b896] hover:bg-[#b5a57d] text-black px-8 py-3 rounded-md font-semibold transition-all duration-300 shadow-md hover:shadow-lg ${isLoaded ? 'animate-slideDown animate-delay-200 animate-gold-shine' : 'opacity-0'}`}
              >
                Client Login
              </button>
            </div>
          ...
          <div className="hidden md:flex items-center justify-center gap-8 px-6 pb-4 border-t border-[#c9b896]/20">
            <button
              onClick={() => scrollToSection('home')}
              className={`text-white hover:text-[#c9b896] font-medium transition-colors duration-300 py-3 ${isLoaded ? 'animate-slideDown animate-delay-300' : 'opacity-0'}`}
            >
              Home
            </button>
            <button
              onClick={() => scrollToSection('services')}
              className={`text-white hover:text-[#c9b896] font-medium transition-colors duration-300 py-3 ${isLoaded ? 'animate-slideDown animate-delay-350' : 'opacity-0'}`}
            >
              Services
            </button>
            <button
              onClick={onViewLearning}
              className={`text-white hover:text-[#c9b896] font-medium transition-colors duration-300 py-3 ${isLoaded ? 'animate-slideDown animate-delay-400' : 'opacity-0'}`}
            >
              Learning
            </button>
            <button
              onClick={onViewNews}
              className={`text-white hover:text-[#c9b896] font-medium transition-colors duration-300 py-3 ${isLoaded ? 'animate-slideDown animate-delay-450' : 'opacity-0'}`}
            >
              News
            </button>
            <button
              onClick={onViewMFResearch}
              className={`text-white hover:text-[#c9b896] font-medium transition-colors duration-300 py-3 ${isLoaded ? 'animate-slideDown animate-delay-500' : 'opacity-0'}`}
            >
              MF Research
            </button>
            <button
              onClick={onViewCalculator}
              className={`text-white hover:text-[#c9b896] font-medium transition-colors duration-300 py-3 ${isLoaded ? 'animate-slideDown animate-delay-550' : 'opacity-0'}`}
            >
              Calculator
            </button>
            <div className="relative">
              <button
                ...
                className={`text-white hover:text-[#c9b896] font-medium transition-colors duration-300 py-3 flex items-center gap-1 ${isLoaded ? 'animate-slideDown animate-delay-600' : 'opacity-0'}`}
              >
                Invest Now
              ...
              {isInvestDropdownOpen && (
                <div
                  onMouseEnter={() => setIsInvestDropdownOpen(true)}
                  onMouseLeave={() => setIsInvestDropdownOpen(false)}
                  className="absolute top-full left-0 mt-0 bg-black border border-[#c9b896]/20 rounded-md shadow-lg min-w-[200px] z-50"
                >
                  <button
            ...
            <button
              ...
              className={`text-white hover:text-[#c9b896] font-medium transition-colors duration-300 py-3 ${isLoaded ? 'animate-slideDown animate-delay-650' : 'opacity-0'}`}
            >
              Contact
            </button>
          </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-black border-t border-[#c9b896]/20 shadow-lg">
            <div className="flex flex-col p-4 space-y-3">
              ...
              <div className="border-t border-[#c9b896]/20 my-2 pt-2">
                <div className="text-[#c9b896] text-xs uppercase tracking-wider px-4 py-2 font-semibold">Employee Login</div>
                <button
                ...
                <button
                  ...
                  className="w-full bg-[#c9b896] hover:bg-[#b5a57d] text-black font-semibold py-3 px-4 rounded mb-3 transition-colors"
                >
                  Client Login
                </button>
              </div>
              <div className="border-t border-[#c9b896]/20 my-2 pt-2">
                <div className="text-[#c9b896] text-xs uppercase tracking-wider px-4 py-2 font-semibold">Invest Now</div>
                <button
                  onClick={() => {
      ...
      <section id="home" className="relative bg-black text-white py-32 px-6 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto text-center">
          <h2 className={`text-6xl font-bold mb-6 leading-tight ${isLoaded ? 'animate-fadeInUp' : 'opacity-0'}`} style={{ fontFamily: 'Playfair Display, Georgia, serif' }}>
            Your Financial Success<br />
            <span className="text-[#c9b896]">is Our Priority</span>
          </h2>
          ...
          <button
            onClick={() => onNavigate('client-login')}
            className={`bg-[#c9b896] hover:bg-[#b5a57d] text-black font-bold py-4 px-10 rounded-md flex items-center gap-3 mx-auto transition-all duration-300 shadow-lg hover:shadow-xl text-lg ${isLoaded ? 'animate-fadeInUp animate-delay-400 animate-float' : 'opacity-0'}`}
          >
      ...
      <section className="relative py-20 px-6 bg-black text-white">
        ...
        <div className="relative max-w-7xl mx-auto">
          <h3 className={`text-4xl font-bold text-center mb-4 ${isLoaded ? 'animate-fadeInUp' : 'opacity-0'}`} style={{ fontFamily: 'Playfair Display, Georgia, serif' }}>
            Why Choose <span className="text-[#c9b896]">Niyom Wealth</span>?
          </h3>
          <div className={`w-24 h-1 bg-[#c9b896] mx-auto mb-16 ${isLoaded ? 'animate-scaleIn animate-delay-200' : 'opacity-0'}`}></div>
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              <div key={i} className={`bg-white/5 backdrop-blur-sm p-8 rounded-xl border-l-4 border-[#c9b896] hover:bg-white/10 transition-all duration-300 ${isLoaded ? `animate-slideInLeft animate-delay-${(i + 2) * 100}` : 'opacity-0'}`}>
                <h4 className="text-2xl font-bold text-[#c9b896] mb-3" style={{ fontFamily: 'Playfair Display, Georgia, serif' }}>{value.title}</h4>
      ...
      <section className="bg-gradient-to-br from-[#c9b896] to-[#b5a57d] text-black py-20 px-6">
        <div className="max-w-5xl mx-auto text-center">
          <h3 className={`text-4xl font-bold mb-6 ${isLoaded ? 'animate-fadeInUp' : 'opacity-0'}`} style={{ fontFamily: 'Playfair Display, Georgia, serif' }}>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className={`bg-gradient-to-br from-black to-gray-900 rounded-xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 group ${isLoaded ? 'animate-fadeInUp animate-delay-100' : 'opacity-0'}`}>
              <div className="flex items-center gap-4 mb-4">
                <div className="bg-[#c9b896] p-4 rounded-full group-hover:scale-110 transition-transform duration-300">
                  <Phone className="w-8 h-8 text-black" />
                </div>
                <h4 className="text-2xl font-bold text-white" style={{ fontFamily: 'Playfair Display, Georgia, serif' }}>
                  Phone
                </h4>
              </div>
              <a
                href="tel:+918939433113"
                className="text-[#c9b896] hover:text-white text-xl font-medium transition-colors duration-300 block"
              >
                +91 8939433113
              </a>
            </div>
            ...
            <div className={`bg-gradient-to-br from-black to-gray-900 rounded-xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 group ${isLoaded ? 'animate-fadeInUp animate-delay-300' : 'opacity-0'}`}>
              ...
              <a
                ...
                className="text-[#c9b896] hover:text-white text-xl font-medium transition-colors duration-300 block break-words"
              >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="text-center md:text-left">
              <h3 className="text-lg font-semibold text-[#c9b896] mb-4">Legal</h3>
            ...
            <div className="text-center md:text-left">
              <h3 className="text-lg font-semibold text-[#c9b896] mb-4">Connect With Us</h3>
          ...
          <div className="text-center text-gray-400 pt-8 border-t border-gray-800">
            <p className="text-sm">&copy; 2025 Niyom Wealth Management LLP. All rights reserved.</p>
