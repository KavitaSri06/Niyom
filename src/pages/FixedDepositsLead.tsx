import { ArrowLeft, Landmark, User, Mail, Phone, DollarSign, Clock, Target, FileText, CheckCircle, Menu, X } from 'lucide-react';
...
export function FixedDepositsLead({ onBack }: FixedDepositsLeadProps) {
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          >
            ...
            <div className="text-left">
              ...
              <p className="text-accent-soft text-xs tracking-widest">FIXED DEPOSITS</p>
            </div>
          </button>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="46 days - 6 months">46 days - 6 months</option>
              ...
              <div>
                ...
                >
                  ...
                  <option value="Flexible">Quarterly Payout</option>
                </select>
              </div>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-900">
                <strong>Note:</strong> We offer FDs from leading banks and NBFCs. Interest rates vary by institution and tenure. All FDs up to ₹5 lakhs are covered by DICGC insurance when held with banks.
              </p>
            </div>
