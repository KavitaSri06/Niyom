        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          >
            ...
            <div className="text-left">
              ...
              <p className="text-[#c9b896] text-xs tracking-widest">MUTUAL FUNDS</p>
            </div>
          </button>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white p-8 rounded-2xl shadow-xl mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-4 mt-6">
            <div className="bg-white/10 backdrop-blur-sm p-4 rounded-lg">
              <p className="text-sm text-blue-100 mb-1">Diversification</p>
              <p className="font-bold text-lg">Spread Risk</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm p-4 rounded-lg">
              <p className="text-sm text-blue-100 mb-1">Professional</p>
              <p className="font-bold text-lg">Expert Management</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm p-4 rounded-lg">
              <p className="text-sm text-blue-100 mb-1">Flexibility</p>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-blue-600 to-blue-800 hover:from-blue-700 hover:to-blue-900 text-white font-bold py-4 px-8 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl text-lg disabled:opacity-50 disabled:cursor-not-allowed"
            >
